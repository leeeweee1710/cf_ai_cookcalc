    ...
    <Card className="w-full bg-white/80 dark:bg-neutral-900/80 border border-neutral-300 dark:border-neutral-800 backdrop-blur px-0 py-0 shadow overflow-hidden flex flex-col h-full">
      ...
      <div className="p-4 flex flex-col gap-4 flex-1">
        <div>
          ...
          <select
            className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white/80 dark:bg-neutral-950/60 px-3 py-2 text-base font-semibold text-neutral-900 dark:text-neutral-50 focus:outline-none focus:ring-2 focus:ring-neutral-300 dark:focus:ring-neutral-600"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              ...
              <div className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-900 px-3 py-2 text-base font-semibold text-neutral-900 dark:text-neutral-50 h-[38px] flex items-center">
                {resultString || "-"}
              </div>
            </div>
            <div className="w-1/3 min-w-[100px]">
